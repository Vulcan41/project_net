...
export default function ProfilePage() {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '600px' }}>
      ...
      <button onClick={() => navigate('/profile/edit')} style={{ padding: '0.6rem 1.5rem', background: '#111', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Edit Profile</button>
    </div>
  )
}
